...
class FilmController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.views.film.index', compact('film'));
    }
    ...
    {
        $genre = Genre::all();
        return view('pages.views.film.create', compact('genre'));
    }
    ...
    public function show(string $id)
    {
        ...
        return view('pages.views.film.detail', compact('film'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('pages.views.film.edit', compact('film', 'genre'));
    }
    ...
    public function storeReview(Request $request, $id)
    {
        ...
        return redirect()->route('film.show', $id)->with('success', 'Review and rating added successfully.');
    }
}
